...
export default {
    ...
    created() {
        window.backAndroidApp = this.backAndroidApp;
        this.$nextTick(() => {
        ...
        if (getRequest().types === "attachment" && localStorage.getItem("attachmentList")) {//缓存附件
            //附件
            this.list = JSON.parse(localStorage.getItem("attachmentList"));
        }
        if (
            getRequest().types === "attachment" &&
        ...
        if (getRequest().types === "text" && localStorage.getItem("textList")) {//缓存正文
            //正文
            this.list = JSON.parse(localStorage.getItem("textList"));
        }

        if (getRequest().types === "text" && !localStorage.getItem("textList")) {//请求列表
            //正文
    ...
    destroyed() {
        ...
        if (getRequest().types === "attachment") {
